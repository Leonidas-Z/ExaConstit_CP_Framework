...
def selNSGA3(individuals, k, ref_points, nd="log", best_point=None,
    ...
    if return_memory:
        return N_non_dom, chosen, NSGA3Memory(best_point, worst_point, extreme_points)
    return N_non_dom, chosen
...
def niching(individuals, k, niches, distances, niche_counts):
    ...
    while len(selected) < k:
        ...
        random.shuffle(selected_niches)
        ...
        for niche in selected_niches:
            ...
            random.shuffle(niche_individuals)
